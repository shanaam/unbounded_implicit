...
bayes_t_test(wo_strat_init_blocks, "exp", "longAbruptExp", "gradualExp", "mean_devs")
bayes_t_test(wo_strat_init_blocks, "exp", "stepwiseExp", "gradualExp", "mean_devs")
bayes_t_test(wo_strat_init_blocks, "exp", "stepwiseExp", "longAbruptExp", "mean_devs")
```
...
```{r}
#plot
plot_group_density(wo_strat_init_blocks, "exp", "mean_devs", title = "A. Initial Implicit Aftereffects")
```
```{r}
# descriptives
...
bayes_t_test(wo_strat_final_blocks, "exp", "longAbruptExp", "gradualExp", "mean_devs")
bayes_t_test(wo_strat_final_blocks, "exp", "stepwiseExp", "gradualExp", "mean_devs")
bayes_t_test(wo_strat_final_blocks, "exp", "stepwiseExp", "longAbruptExp", "mean_devs")
```

```{r}
#plot
plot_group_density(wo_strat_final_blocks, "exp", "mean_devs", title = "B. Block 4 Implicit Aftereffects")
```
...
bayes_t_test(strat_initial_blocks, "exp", "longAbruptExp", "gradualExp", "strategy")
bayes_t_test(strat_initial_blocks, "exp", "stepwiseExp", "gradualExp", "strategy")
bayes_t_test(strat_initial_blocks, "exp", "stepwiseExp", "longAbruptExp", "strategy")
```

```{r}
#plot
plot_group_density(strat_initial_blocks, "exp", "strategy", title = "A. Initial Strategy")
```
...
```{r}
#plot
plot_group_density(strat_final_blocks, "exp", "strategy", title = "B. BLock 4 Strategy")
```
...
bayes_t_test(strat_final_blocks, "exp", "longAbruptExp", "gradualExp", "strategy")
bayes_t_test(strat_final_blocks, "exp", "stepwiseExp", "gradualExp", "strategy")
bayes_t_test(strat_final_blocks, "exp", "stepwiseExp", "longAbruptExp", "strategy")
```
...
```{r}
plot_group_density(rot_training_trial_sets, "trial_set", "angular_dev_mean", subgroup = "exp", title = "Training trial sets")
```
...
```{r}
#plot
plot_group_density(training_final_trial_set, "exp", "angular_dev_mean", title = "BLock 4 Strategy")
```
...
bayes_t_test(training_final_trial_set, "exp", "longAbruptExp", "gradualExp", "angular_dev_mean")
bayes_t_test(training_final_trial_set, "exp", "stepwiseExp", "gradualExp", "angular_dev_mean")
bayes_t_test(training_final_trial_set, "exp", "stepwiseExp", "longAbruptExp", "angular_dev_mean")
```
