...
setwd("D:/shanaa/exp/rigidImplicit/data")

rawDataEI <- read.csv("multipleRotation/rigid_implicit_exp_EI_trial.csv")
rawDataIE <- read.csv("multipleRotation/rigid_implicit_exp_IE_trial.csv")
...
write.csv(transposedMasterCSV, file= "noCursorMedians.csv")
